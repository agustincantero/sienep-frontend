...
// Chrome de las pantallas de autenticación (fuera del AppShell de funcionario): sin nav, logo grande arriba de la card, fondo con fotos del campus + filtro celeste (LoginBackground, decorativo) y footer. El fondo va en su propia capa; el contenido en z-10 encima.
